...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h1 class="mt-5" style="color: #FEE86B;">Mulai Belajar Python</h1>
    </div>
    <div class="col-md-12 mt-3" style="color:white" >
    ...
    <div class="col-md-12 mt-5 mb-5">
      ...
      <button type="button" class="btn"
        style="--bs-btn-padding-y: .30rem; --bs-btn-padding-x: .9rem; --bs-btn-font-size: .99rem; background-color: #FEE86B; color: black;">
        Pelajari Sekarang 
      </button>
    </div>
  ...
  <!-- <nav class="navbar navbar-expand-lg" > -->
    <!-- <div class="container-fluid py-2"> -->
      ...
      <!-- <ul style="display: flex;">
        <a href="#"><li style="list-style: none;" class="px-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" fill="currentColor"
        ...
        <a href="#"><li style="list-style: none;" class="px-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" fill="currentColor"
          ...
          <a href="#"><li style="list-style: none;" class="px-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-twitter"
            viewBox="0 0 16 16">
            <path
              d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
          </svg></li></a>

          <a href="#"><li style="list-style: none;" class="px-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-facebook"
            viewBox="0 0 16 16">
            <path
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav" style="font-size: 15px;">
          ...
          <li class="nav-item">
            <b><a class="nav-link" href="#">CONTACT</a></b> 
          </li>
          <li class="nav-item">
            <b><a class="nav-link" href="#">PRESS</a></b> 
          </li>
          <li class="nav-item">
            <b><a class="nav-link" href="#">DONATE</a></b> 
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container-fluid" style="background-color: #D4DDE6;">
    <div class="row align-items-center">
      <div class="col-md-6 col-sm-12">
        <ul style="display: flex;">
          <a href="#">
            <li style="list-style: none;" class="p-3"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="19"
          ...
          <a href="#">
            <li style="list-style: none;" class="p-3"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="16"
      ...
      <div class="col-md-6">
        <ul style="display: flex; ">
          ...
          <li style="list-style: none;">ABOUT</li>
          <li style="list-style: none;">CONTACT</li>
          <li style="list-style: none;">PRESS</li>
          <li style="list-style: none;">DONATE</li>
        </ul>
      </div>
    </div>
  </div>
